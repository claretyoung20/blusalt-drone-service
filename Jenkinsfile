pipeline {
    ...
    post {
        failure {
            mail body: "Check build logs at ${env.BUILD_URL}", from: 'jenkins-admin@gmail.com', subject: "Jenkins pipeline has failed for job ${env.JOB_NAME}", to: "${env.CHANGE_AUTHOR_EMAIL}"
        }
        success {
